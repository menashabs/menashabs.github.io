...
## Statistics Tutor (September 2026 - Present)

**Preply: Online Platform**

#### Online Statistics Tutor | [**View Tutor Profile**](https://preply.com/en/tutor/7625713){target=_blank}

::: {style="text-align: justify;"}
* Provide one-to-one online Statistics tutoring to learners from diverse international backgrounds.
* Tailor lessons to individual learning needs, university course requirements, and academic goals.
* Support students with statistical concepts, data analysis, and statistical software.
:::
...
#### Research project using statistical and machine learning methods

::: {style="text-align: justify;"}
* Working on a granted research project under grant number SRC/LT/2026/11. This project is on the supply of NVQ Level 4 health-sector programmes in Sri Lanka and factors influencing their future demand.
* Contribute to interdisciplinary research using statistical and machine learning methods, including questionnaire development, primary data collection, data preprocessing, statistical analysis, predictive modelling, literature reviews, and research manuscript preparation. 
:::

----

## Founder, Consultant & Educator (October 2025 - Present)

**Brainy Stat: Where Data Meets Clarity**

#### Online statistical consultancy and education platform

::: {style="text-align: justify;"}
* Founded and developed an online platform providing statistical consultancy, teaching, and data analysis services.
* Provide support in Statistics, statistical modelling, data analysis, and R programming.
* Develop educational content and resources through the Brainy Stat website, YouTube channel, and LinkedIn platform.
:::

<div style="text-align: center;">
<a href="https://brainystatisticswork.netlify.app" target="_blank">**Website**</a> &nbsp; | &nbsp;
<a href="https://www.youtube.com/@BrainyStat-98" target="_blank">**YouTube**</a> &nbsp; | &nbsp;
<a href="https://www.linkedin.com/company/brainy-stat/" target="_blank">**LinkedIn**</a>
</div>

![](image_brainystat.jpg){width=200 height=200 style="display:block;margin-left:auto;margin-right:auto;"}
...
::: {style="text-align: justify;"}
* Supervised a Higher Diploma in Applied Statistics Batch 3 research projects titled "Predictive Model to
Forecast Detection Probability: A Study in Air Surveillance Radars".
* Supervised a Higher Diploma in Applied Statistics Batch 4 research projects titled "The Use of Machine Learning Algorithms to to Predict Antibiotic Absorption of biochar".
:::

----

## Assistant Lecturer (September 2024 - August 2025)
...
::: {style="text-align: justify;"}
* **Member (April 2025 - March 2026)** <br>
Academic training committee <br> 
Institute of Applied Statistics Sri Lanka (IASSL)
* **Member and Editorial Assistant (April 2025 - September 2025)** <br>
...
* **Editorial Assistant (January 2025 - April 2025)** <br>
Best Research Awards 2024 <br>
Institute of Applied Statistics Sri Lanka (IASSL)
* **Editorial Assistant (August 2024 - December 2024)** <br>
...
* **Examiner (November 2023 - December 2023)** <br>
